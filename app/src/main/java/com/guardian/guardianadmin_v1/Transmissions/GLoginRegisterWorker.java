...
import com.guardian.guardianadmin_v1.Gonnect;
...
public class GLoginRegisterWorker extends AsyncTask<String,Void,String> {
    Context context;
    public GLoginRegisterWorker(Context ctx){
        context = ctx;
    }
    @Override
